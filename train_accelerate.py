...
def main(args, unparsed):
    ...
    if accelerator.is_main_process:
        import wandb
        wandb.init(project="in1k-gen", name=args.exp_name)
    ...
    elif args.model_domain == 'dico':
        from dico_models import DiT_models
    else:
    ...
    if accelerator.is_main_process:
        logger.info(f"Dataset contains {len(dataset):,} images ({args.data_path}) ({args.feature_path})")
        ...
        for x, y in loader:
            ...
            if train_steps % args.log_every == 0:
                ...
                if accelerator.is_main_process:
                    ...
                    wandb.log({"Training Loss":avg_loss}, step=train_steps)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-domain", type=str, default='dit')
